...
class Config:
    ...
    RECIPIENT_NAME = None # Stores "Dad", "Mom", "Bestie", etc.

    SAFE_PACKAGES = [
        "com.google.android.youtube", "com.google.android.apps.docs",
        "com.adobe.reader", "com.google.android.apps.docs.editors.docs",
        "com.google.android.apps.docs.editors.sheets", "com.microsoft.office.word",
        "com.android.chrome", "org.mozilla.firefox", "com.google.android.apps.nbu.files"
    ]
